...
def test_task_in_world_state(
    ...
    task_id, _ = create_task(pi_api_base, pi_entity_id, task_id_prefix="subscribed")
    ...
    assert task_in_world_state_dict(data, task_id), f"Task {task_id} not in top-level tasks dict"
